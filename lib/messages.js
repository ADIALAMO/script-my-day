...
const MAP = {
  ...
  [CODES.QUOTA_IDENTITY]: {
    isQuota: true,
    en: "🎭 You've used all your character-image credits this month. They refresh on the 1st.",
    he: '🎭 ניצלת את כל קרדיטי הדמות החודשיים. הם מתחדשים ב-1 לחודש.',
  },
  [CODES.IDENTITY_LIFETIME_USED]: {
    isQuota: true,
    en: "🎭 You've already cast yourself in your free poster! Upgrade to Pro to create new characters and full comics.",
    he: '🎭 כבר ניצלת את הפוסטר החינמי שלך! שדרג ל-Pro כדי ליצור דמויות חדשות וקומיקסים מלאים.',
  },
