...
const MAP = {
  [CODES.QUOTA_SCRIPT]: {
    isQuota: true,
    en: "🎬 That's a wrap for today. You've used all 5 of your daily scripts — come back tomorrow for your next premiere.",
    he: '🎬 הצילומים של היום הסתיימו. ניצלת את 5 התסריטים היומיים — נתראה מחר בבכורה הבאה.',
  },
  [CODES.QUOTA_SCRIPT_GUEST]: {
    isQuota: true,
    en: '🎬 Guest quota reached. Sign in with your email for a renewing daily quota — 5 scripts, posters & comics, free.',
    he: '🎬 נגמרה המכסה לאורחים. התחבר עם המייל וקבל מכסה יומית מתחדשת — 5 תסריטים, פוסטרים וקומיקס, בחינם.',
  },
  [CODES.QUOTA_POSTER]: {
    isQuota: true,
