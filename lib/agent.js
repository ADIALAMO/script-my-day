...
function buildComicScriptPrompt(userText, genre) {
  ...
  const userInstruction = lang === "he"
    ? `להלן טקסט יומן של משתמש. אנא המר/י אותו לתסריט ${genreLabel} מקצועי, מחולק לסצנות/פאנלים. שמור/י על כל האירועים, הדמויות והרצף הכרונולוגי כפי שהם מופיעים בטקסט המקורי. ניתן להוסיף תיאור חזותי, מחשבות פנימיות ותגובות קצרות טבעיות, אך אין לשנות עובדות. הפלט יהיה בשפה של הטקסט.`
