...
poster: "A textless Wacky comedy movie style poster, depicting [STORY_CONTEXT], bright saturated colors, exaggerated funny expressions, chaotic and hilarious atmosphere, 8k, cinematic lighting.(No text, no letters, no words, no title, no credits)"    },
    action: {
...
poster: "A textless High-octane action movie style poster, depicting [STORY_CONTEXT], intense dynamic poses, massive explosions, cinematic teal and orange palette, flying debris, 8k resolution.(No text, no letters, no words, no title, no credits)"   },
    horror: {
...
poster: "A textless Dark horror movie style poster, depicting [STORY_CONTEXT], lurking shadows, terrifying atmosphere, unsettling cinematic lighting, muted colors, 8k resolution.(No text, no letters, no words, no title, no credits)"    },
    drama: {
...
poster: "A textless Cinematic drama movie style poster, depicting [STORY_CONTEXT], intimate close-up on emotional expression, moody lighting, shallow depth of field, cinematic grain, 8k.(No text, no letters, no words, no title, no credits)"    },
    romance: {
...
poster: "A textless Romantic movie style poster, depicting [STORY_CONTEXT], warm soft lighting, intimate atmosphere, cinematic bokeh, 8k, golden hour.(No text, no letters, no words, no title, no credits)"    },
   "sci-fi": {
...
poster: "A textless Epic sci-fi movie style poster, depicting [STORY_CONTEXT], futuristic neon aesthetic, high-tech atmosphere, vast scale, 8k.(No text, no letters, no words, no title, no credits)"    }
  }
};
