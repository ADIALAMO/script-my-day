...
poster: "Hilarious comedy movie poster, [STORY_CONTEXT], bright saturated colors, exaggerated facial expressions, chaotic slapstick situation, wacky atmosphere, 8k, cinematic lighting."    },
    action: {
...
poster: "High-octane action movie poster, [STORY_CONTEXT], intense dynamic poses, massive explosions and sparks, cinematic teal and orange palette, flying debris, 8k resolution, motion blur."  },
    horror: {
...
poster: "Terrifying horror movie poster, [STORY_CONTEXT], lurking in the heavy shadows, chiaroscuro lighting, unsettling atmosphere, muted colors, 8k resolution, cinematic horror aesthetic."    },
    drama: {
...
poster: "Award-winning drama movie poster, [STORY_CONTEXT], intimate close-up on emotional expression, moody lighting, shallow depth of field, cinematic grain, 8k."    },
    romance: {
...
poster: "Romantic and emotional movie poster, [STORY_CONTEXT], warm soft lighting, intimate atmosphere, two people sharing a deep moment, cinematic bokeh, 8k, golden hour."    },
   "sci-fi": {
...
poster: "Epic sci-fi movie poster, [STORY_ELEMENTS], futuristic cityscape, neon lights, cyberpunk aesthetic, high-contrast lighting, cinematic atmosphere, 8k."}
  }
};
