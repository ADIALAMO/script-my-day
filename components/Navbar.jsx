...
export default function Navbar({ lang, onLanguageToggle }) {
  return (
<nav className="px-3 py-3 md:py-4 md:px-6 border-b border-white/10 flex justify-between items-center bg-black/80 backdrop-blur-md sticky top-0 z-[100] w-full">
